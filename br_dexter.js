br_dexter = {
    ...
    thinkAboutIt: function(self, enemies, bullets, objects, events) {
        ...
        const storyOfLife = [
            ...
            "I want to talk about " + this.motherFucker.name + ".",
            ...
            "All that matters is " + this.motherFucker.name + ".",
        ...
        bullets.forEach(bullet => {
            ...
            dist = distanceBetween(this.motherFucker, bullet)
        ...
        if (self.bullets * bulletDamage >= this.motherFucker.lives) {
            this.shootAtEnemy(self, motherFucker);
        }

        if (self.bullets == creatureMaxBullets || this.rageMode) {
            this.rageMode = true;
            return this.shootAtEnemy(self, this.motherFucker);
        }
